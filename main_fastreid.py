...
def get_parser():
    ...
    parser.add_argument(
        "--config-file",
        default='/media/zengwb/PC/baseline/ReID/fast-reid-master/sbs_R50-ibn-model/config.yaml',
        metavar="FILE",
...
# parser = argparse.ArgumentParser(description='Face Cluster')
    ...
    # cluster config
    parser.add_argument('--input_picture_path', default='/media/zengwb/PC/Dataset/ReID-dataset/channel1/provate3', type=str)
